...
void paDrawString(cv::Mat& _dst, const char* str, cv::Point org, cv::Scalar color, int fontSize, bool bold, bool italic, bool underline)
...
// #include <opencv/cv_import_static_lib.h>
// #include <highgui.h>
// int main(int argc, char* argv[])
// {
// 	IplImage* img = cvLoadImage("F:/cv/image/x.jpg", 1);
// 	paDrawString(img, "是\n不是\n哈哈\n", cvPoint(0, 0), 16, cvScalar(255), false, false);
// 	cvShowImage("img", img);
// 	cvWaitKey();
// 	return 0;
// }